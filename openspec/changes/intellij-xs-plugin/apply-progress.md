...
- [x] **0.4 — Build validation + bundled-resource guard + CI**: added `validateBundledResources` Gradle task; created `.github/workflows/intellij-xs-plugin.yml` running `./gradlew buildPlugin` and `./gradlew test`.
