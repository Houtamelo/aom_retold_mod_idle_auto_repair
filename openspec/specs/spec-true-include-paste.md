...
> **Added by change:** `true-include-paste`
> **Archived:** 2026-06-25
...
|---|---|---|---|
| `true-include-paste` | 2026-06-25 | PASS WITH DEVIATIONS | New spec covering grammar fix, merged-view include-paste semantics, visibility, and cross-file LSP features. |
